...
(function (element) {
    ...
    $tab.on('click.ltabs-tab', function () {
        ...
        if (!loaded && !_items_active.hasClass('ltabs-process')) {
            ...
            if ($tabs.parents('.ltabs-tabs-container').attr('data-ajaxurl') == 1) {
                path_url = '../Product/ProductTabbedBestSellerProduct';
            }
            if ($tabs.parents('.ltabs-tabs-container').attr('data-ajaxurl') == 2) {
                path_url = '../Product/ProductTabbedNewProduct';
            }
...
$(document).ready(function () {
    $.ajax({
        dataType: 'JSON',
        type: 'Get',
        url: '../Shop/GetHomePagePaidShops',
        contentType: 'application/json;',
        beforeSend: function() {
            $('.shops1').append("<img src='../Content/image/theme/lazy-loader.gif'/>");
        },
        success: function (data) {
            $('.shops1').children('img').remove();
            $('.shops1').append(data);
