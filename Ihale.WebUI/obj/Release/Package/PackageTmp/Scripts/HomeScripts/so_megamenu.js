...
$(document).ready(function() {
    $('.megamenu>li').removeClass('home');
    for (var i = 0; i < $('.megamenu>li').length ; i++) {
        if ($('.megamenu>li').children('a').eq(i).attr('href') == window.location.pathname) {
            $('.megamenu>li').eq(i).addClass('home');
            break;
        }
